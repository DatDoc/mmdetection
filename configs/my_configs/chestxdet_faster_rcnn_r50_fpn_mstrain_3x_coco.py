...
log_level = 'INFO'
load_from = '/root/workspace/repo/mmdetection/checkpoints/faster_rcnn_r50_fpn_mstrain_3x_coco_20210524_110822-e10bd31c.pth'
resume_from = None
workflow = [('train', 1)]
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            classes=('Atelectasis', 'Calcification', 'Cardiomegaly',
                     'Consolidation', 'Diffuse Nodule', 'Effusion',
                     'Emphysema', 'Fibrosis', 'Fracture', 'Mass', 'Nodule',
...
classes = ('Atelectasis', 'Calcification', 'Cardiomegaly', 'Consolidation',
           ...
           'No finding')
work_dir = '/root/workspace/results/faster_rcnn_r50_fpn_mstrain_3x_coco/chestxdet_module1'
seed = 2021
gpu_ids = range(0, 1)