model = dict(
    ...
    roi_head=dict(
        ...
        sar_modules=dict(
            ...
            d_model=8,
            pretrainedPSPNet='/content/mmdetection/checkpoints/pspnet_chestxray_best_model_4.pkl',
            batch_size=2),
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/content/coco_format/fold0/train.json',
        img_prefix='/content/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/content/coco_format/fold0/valid.json',
        img_prefix='/content/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
